...
var huke = [["string", 454, false], ["we can store multiple strings", 5684, false]]; // can store multiple tuples
var hjr = ["acer", "dell", 82541]; //cannot store multiple tuples 
...
*/
var arry = ["elementNumberOne", "elementNumberTwo"];
 ...
 */
var tuple_ex = ["beta", 7848, "string", true];
...
var this_arr = ["all", "man", "are", "born", "equally"]; // hover over this_arr to see inference---> let this_arr: string[]
var this_tup = [414, "string", true]; // hover over this_tup to see ---> let this_tup: (string | number | boolean)[]
...
var more = [0, 21, 45];
var moreMe = ["string", "ch", "get"];
var nMore = __spreadArray([], more, true); // 0,21,45 // creating new array from existing array
var nMoreMe = __spreadArray(__spreadArray([], moreMe, true), ["adding more elements"], false); // string,ch,get,adding more elements
var combined_array = __spreadArray(__spreadArray([], more, true), moreMe, true); // 0,21,45,string,ch,get,adding more elements
...
// Eg of Complex Types
var myType;
function testTy(param) {
    // code here
}
var storeFun = testTy(myType);
...
var showW; // no error as it exists inside the Direction as variable value
// Any other values beside birth, death are not allowed and this is law of nature
var Cycle;
(function (Cycle) {
    Cycle[Cycle["Birth"] = 0] = "Birth";
    Cycle[Cycle["Death"] = 1] = "Death";
})(Cycle || (Cycle = {}));
var showE; // Enum can used in type annotation like any other type - let ayrt: string[];
...
var DirectionT;
(function (DirectionT) {
    DirectionT[DirectionT["North"] = 7] = "North";
    DirectionT[DirectionT["South"] = 8] = "South";
    DirectionT[DirectionT["East"] = 9] = "East";
    DirectionT[DirectionT["West"] = 10] = "West"; // equals to 10
})(DirectionT || (DirectionT = {}));
// More customizing on enum ordering
var DirectionC;
(function (DirectionC) {
    DirectionC[DirectionC["North"] = 9] = "North";
    DirectionC[DirectionC["South"] = 4] = "South";
    DirectionC[DirectionC["East"] = 1] = "East";
    DirectionC[DirectionC["West"] = 3] = "West";
...
*/
var this_is_number;
(function (this_is_number) {
    this_is_number[this_is_number["North"] = 0] = "North";
    this_is_number[this_is_number["South"] = 1] = "South";
    this_is_number[this_is_number["East"] = 2] = "East";
    this_is_number[this_is_number["West"] = 3] = "West";
})(this_is_number || (this_is_number = {}));
var this_is_string;
(function (this_is_string) {
    this_is_string["North"] = "NORTH";
    this_is_string["South"] = "SOUTH";
    this_is_string["East"] = "EAST";
    this_is_string["West"] = "WEST"; // must write the string explicitly as North = 'NORTH' is a valid value definition
})(this_is_string || (this_is_string = {}));
...
var yPerson = { name: 'Jackson', id: 708 };
...
var anTy = "This is string! Hi from okland"; // valid code 
// Let's understand with an example
var thiCompany;
var TiCompany;
var firstStr = "test is string";
var secondStr = firstStr; // Here thisStri and yoStr are just alternative names for the same thing.
// let codecademyCoordinates: [number, number, string, number, number, string] = [40, 43.2, 'N', 73, 59.8, 'W'];
// let bermudaTCoordinates: [number, number, string, number, number, string] = [25, 0 , 'N' , 71, 0, 'W'];
var codecademyCoordinates = [40, 43.2, 'N', 73, 59.8, 'W']; // see we have wrote more cleaner and readable code
var bermudaTCoordinates = [25, 0, 'N', 71, 0, 'W'];
var myHouseCoordindate = [45, 85, 'E', 13, 85, 'W'];
// storing the function inside the meroFunc variable
var meroFunc;
meroFunc = function (firstName, lastName) {
    return firstName.length + lastName.length;
};
meroFunc = function (firstParam, secondParam) {
...
function anotherFilling(value, n) {
    return Array(n).fill(value);
}
...
var coordinateArray;
// Write your code below:
stringArrayT = getFilledArray('hi', 6);
...
var my_ID; // allow us to define multiple type members separated by vertical line character | 
my_ID = 708;
my_ID = "E-708"; // re-using the program here
console.log("Id is ".concat(my_ID));
var my_Age; // more flexible & safer than any
my_Age = "twenty-three";
console.log("My age in string is ".concat(my_Age));
my_Age = 23;
console.log("My age in number is ".concat(my_Age));
...
function hubID(param) {
    ...
    if (typeof param === 'string') {
        return " hub is currently in ".concat(param, " state and !") + param.toUpperCase();
    }
    return "hub is currently in ".concat(param, " state");
}
...
function getGuitars() {
    try {
        ...
        return " Something went error".concat(error);
    }
}
function createUser() {
 ...
 */
// Examples
var dateNumber = new Date().getTime(); // returns a number
var dateString = new Date().toString(); // returns a string
var timesList = [dateNumber, dateString];
